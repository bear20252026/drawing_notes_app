// editor_v2——ZoomControls 缩放控件（Excalidraw 借鉴—�?026-08-21）�?//
// Excalidraw 右下角缩放控件本地化——积木式独立 Widget�?// 缩放滑块/重置/适应窗口/百分比显示——与 InfiniteCanvasNotifier 集成�?// 不修改现有功能——保证现有功能正常——不搞崩�?library;
...
/// 功能�?/// - 缩放滑块�?.1x ~ 10x�?/// - 百分比显示（当前缩放比）
/// - 缩小/放大按钮�?/+/fit�?/// - 重置按钮�?x�?/// - 适应窗口按钮（fit to screen�?///
/// 设计：积木式——独�?Widget——不耦合其他组件——可插拔�?class ZoomControls extends ConsumerWidget {
  const ZoomControls({super.key, this.onFitToScreen});

  /// 适应窗口回调（外部提供——可选）�?  final VoidCallback? onFitToScreen;
