// editor_v2——MagnifierOverlay 取色放大镜（用户需求 #7——2026-08-24）。
//
// 用户需求：取色板功能困难——应在鼠标所指位置中央生成小放大镜——
// 放大显示那到底是什么颜色。
//
// Excalidraw 借鉴：取色放大镜 + 十字准线 + HEX 颜色值显示。
library;
...
///
/// 显示效果：
/// - 圆形放大镜（显示 cursor 周围区域的放大视图）
/// - 十字准线（标记取色中心点）
/// - HEX 颜色值标签（放大镜下方显示当前颜色）
/// - 圆形边框（高亮当前取色区域）
...
/// 放大镜自定义绘制器（Excalidraw 借鉴——像素网格 + 十字准线）。
class _MagnifierPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // 网格线（模拟像素放大效果——Excalidraw 像素网格风格）。
