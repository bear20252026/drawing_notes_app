// 应用刷新基建——首页数据变更通知与路由可见性兜底。
//
// 原 `features/security/sync_fix.dart`（更早溯源：
// `lib/fix/security_and_sync_fix.dart` PART 1，M1 目录迁移）。审计
// 2026-09-26 #43：以「Fix」命名的常驻 production 代码掩盖职责，且
// 路由可见性与 security 域无关——归位 core/navigation 并更名
// SyncFix → AppRefresh，行为零变化。

import 'package:flutter/material.dart';

/// 数据变更通知与路由可见性兜底（app 级基建）。
///
...
abstract final class AppRefresh {
  ...
  /// 首页可通过 [AppRefreshRouteAware] 在重新可见时自动刷新。
...
///     }
///   }
mixin AppRefreshRouteAware<T extends StatefulWidget> on State<T>
